...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
 ...
 useEffect(() => {
  ...
  const value: AppContextType = {
    ...
    updateBankAccount: (id, d, o) => api.updateBankAccount(id, d, o).then(r => { setCurrentUser(r.user); addNotification('Bank info updated', 'success'); return { success: true }; }).catch(e => { addNotification(e.message, 'error'); return { success: false }; }),
    ...
    updateFundPassword: (id, n, o) => api.updateFundPassword(id, n, o).then(r => { setCurrentUser(r.user); addNotification('Fund pwd updated', 'success'); return { success: true }; }).catch(e => { addNotification(e.message, 'error'); return { success: false }; }),
